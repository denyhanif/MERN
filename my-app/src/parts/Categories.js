...
export default function Categories({data}) {//{propsnya di destructor}{data} artiny hanya menerima tau props saja bukan (preops.data)
                    ...
                    <div className="container-grid">
                        {
                            ...
                            <div className="row">
                                ...
                                return <div className="item column-3 row-1"
